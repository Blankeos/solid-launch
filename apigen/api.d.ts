...
declare function getUserResponseDTO(user: InternalUserDTO, session: InternalSessionDTO): Promise<{
    id: string;
    email: string;
...
}, "/auth"> | hono_types.MergeSchemaPath<{
    "/": {
        $get: {
            input: {};
            output: {
...
}, "/auth/organizations"> | hono_types.MergeSchemaPath<{
    "/checkout/:variantId": {
        $get: {
            input: {
                param: {
...
}, "/payments"> | hono_types.MergeSchemaPath<hono_types.BlankSchema, "/testmail">, "/">;
