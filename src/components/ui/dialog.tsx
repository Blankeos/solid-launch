...
const DialogOverlay = <T extends ValidComponent = 'div'>(
  ...
  return (
    <DialogPrimitive.Overlay
      class={cn(
        'bg-background/80 data-[expanded]:animate-fadeIn data-[closed]:animate-fadeOut data-[closed]:fade-out-0 data-[expanded]:fade-in-0 fixed inset-0 z-50',
        props.class
      )}
      {...rest}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        class={cn(
          'bg-background data-[expanded]:animate-flyUpAndScale data-[closed]:animate-flyUpAndScaleExit data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95 data-[closed]:slide-out-to-left-1/2 data-[closed]:slide-out-to-top-[48%] data-[expanded]:slide-in-from-left-1/2 data-[expanded]:slide-in-from-top-[48%] fixed top-1/2 left-1/2 z-50 grid max-h-screen w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto border p-6 shadow-lg duration-200 sm:rounded-lg',
          props.class
        )}
        {...rest}
      >
